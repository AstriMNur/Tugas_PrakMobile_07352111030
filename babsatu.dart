...
void main() {
  AdminUser admin = AdminUser('Cidow', 30);
  CustomerUser customer = CustomerUser('Intana', 25);
...
// ! variabel yang tidak akan bernilai Null
// ? suatu variabel yang daoat bernilai Null
// ?? memberi